...
public class DefaultJsonErrorBuilder extends DefaultErrorBuilder{
    ...
    protected String serializeError(Error error) {
        try {
            return jsonConverter.writeValueAsString(error);
        } catch (JsonProcessingException e) {
            e.printStackTrace();
            return "Conversion error in 'DefaultJsonErrorBuilder'";
        }
    }
